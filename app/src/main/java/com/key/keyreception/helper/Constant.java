...
import static com.key.keyreception.helper.ImageRotator.decodeBitmap;
...
public class Constant {
    ...
    public static int Other_User_id = 0;
    ...
    public static SpannableStringBuilder liveWireText(Context mContext) {
        ...
        Name1.setSpan(new ForegroundColorSpan(ContextCompat.getColor(mContext, R.color.colorgray)), 0, Name1.length(), 0);
    ...
    public static SpannableStringBuilder dateTextColorChange(Context mContext, String start){
        ...
        userName.setSpan(new ForegroundColorSpan(ContextCompat.getColor(mContext, R.color.colorgray)), 0, 2, 0);
