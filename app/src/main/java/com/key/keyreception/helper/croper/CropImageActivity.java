package com.key.keyreception.helper.croper;// "Therefore those skilled at the unorthodox
...
public class CropImageActivity extends AppCompatActivity implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        try {
            cropIcon = ContextCompat.getDrawable(this, R.drawable.ic_done_sv);
            if (cropIcon != null) {
    ...
    /**
     * Update the color of a specific crop_image_menu item to the given color.
     */
