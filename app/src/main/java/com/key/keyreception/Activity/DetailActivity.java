...
//            session.putmyjobdetail(reference_id);
                    ...
                    switch (response.code()) {
                        case 200: {
                            ...
                            if (statusCode.equals("success")) {
                                ...
                                setDetailData(propertyName,address,bedroom,bathroom,propertySize,price,serviceDate,status,title,description,"",image);
                            } else {
    ...
    private void setDetailData(String pname, String add, String bed, String bath, String psize, String price, String stdate, String status, String sname, String des, String vname, String simage)
    {
