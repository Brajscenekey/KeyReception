...
public class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RequestAdapter.MyViewHolder holder, final int position) {
        ...
        try {
            if (requestData.getJobDetail().get(position).getServiceDate().contains("-")) {
                ...
                holder.tv_Myjob_time.setText(requestData.getJobDetail().get(position).getServiceDate());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ImageView iv_rprof_img, requestarrow;
