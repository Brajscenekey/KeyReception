...
public class RequestData {
    ...
    private List<MyJobData.PropertyImgBean> propertyImg;

    public RequestData(int _id, int jobId, int senderId, int receiverId, String requestTime, String expireTime, List<CategoryBean> category, List<SenderDetailBean> senderDetail, List<ReciverDetailBean> reciverDetail, List<JobDetailBean> jobDetail, List<MyJobData.PropertyImgBean> propertyImg) {
        this._id = _id;
        this.jobId = jobId;
    ...
    public List<MyJobData.PropertyImgBean> getPropertyImg() {
        return propertyImg;
    }

    public void setPropertyImg(List<MyJobData.PropertyImgBean> propertyImg) {
        this.propertyImg = propertyImg;
    }
