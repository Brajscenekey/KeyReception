...
import com.key.keyreception.activity.ActivityAdapter.FaqAdapter;
...
public class FaqActivity extends BaseActivity {
    ...
    void getFaqList() {
        ...
        Call<ResponseBody> call = RetrofitClient.getInstance()
                .getAnotherApi().getFaqList("de4b20c7699b14fe1a38251be1fbd820f2039a9c");
                        ...
                        case 200: {
                            ...
                            if (status.equals("success")) {
                                ...
                                if (data.length() != 0) {
                                    ...
                                    ArrayList<FaqResponce.DataBean> arrayList = new ArrayList<>();
                                    for (int i = 0; i < data.length(); i++) {

                                        JSONObject jsonObject1 = data.getJSONObject(i);
                                        FaqResponce.DataBean dataBean = new FaqResponce.DataBean();
                                    ...
                                    faqAdapter = new FaqAdapter(FaqActivity.this, arrayList);
